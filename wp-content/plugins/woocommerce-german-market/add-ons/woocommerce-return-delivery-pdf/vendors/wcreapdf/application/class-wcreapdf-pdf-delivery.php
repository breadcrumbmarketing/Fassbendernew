		...
		*/
		public function wc_output( $order, $download, $test, $for_zip = false, $admin = false ) {
			...
			if ( $download === false ) {
				...
				$filename = WCREAPDF_Helper::utf8_decode( get_option( WCREAPDF_Helper::get_wcreapdf_optionname( 'pdf_file_name_delivery' ), __( 'Delivery-Note', 'woocommerce-german-market' ) ) ) . $suffix;
